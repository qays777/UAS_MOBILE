...
class DetailwaterView extends StatefulWidget {
  const DetailwaterView({super.key});

  @override
  State<DetailwaterView> createState() => _DetailwaterViewState();
}

class _DetailwaterViewState extends State<DetailwaterView> {
  @override
              ...
              Center(
                child: Container(
                  ...
                  decoration: const BoxDecoration(
                      image: DecorationImage(
                          image: AssetImage(
                    "assets/images/img_detailwater.png",
                  ))),
                ),
              ),
              const SizedBox(
